        ...
        <div className="App">
            {!showMap ? (
                ...
                <div className="intro-screen">
                    ...
                    {/* Static map image (as a placeholder) */}
                    <img 
                        src="https://maps.googleapis.com/maps/api/staticmap?center=Guelph,ON&zoom=12&size=600x400&key=YOUR_GOOGLE_MAPS_API_KEY" 
                        alt="Static Map" 
                        style={{ width: '100%', height: 'auto', marginTop: '20px' }}
                    />
                </div>
            ) : (
                // Full-screen Google Map iframe (interactive)
